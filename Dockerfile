...
# RUN echo -n 'www-data:dev' | chpasswd
...
RUN apt-get install -y 	openssh-server software-properties-common mysql-server mysql-client nginx \
						python-setuptools curl git unzip
...
RUN apt-get install -y 	php7.0-common php7.0-cgi php7.0-cli php7.0-phpdbg php7.0-fpm php7.0-dbg \
						php7.0-curl php7.0-gd php7.0-imap php7.0-intl php7.0-ldap php7.0 php7.0-json \
						php7.0-sqlite3 php7.0-mysql php7.0-opcache
